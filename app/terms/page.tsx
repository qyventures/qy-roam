export default function TermsPage() {
  return <main className="wrap section legal">
    <span className="eyebrow">Terms</span><h1>Rental Terms</h1>
    <p>Last updated: 26 August 2026</p>
    <p>These terms govern pocket WiFi rentals supplied by QY Venture Pte. Ltd. under the QY Roam brand. By placing an order you agree to these terms.</p>
    ...
    <h2>Rental period and service</h2>
    <p>The rental period is based on the travel dates selected at checkout. Coverage, speed and availability depend on overseas network operators and local conditions. Data plans may be subject to fair-use or speed-management policies stated on the selected plan.</p>
    <h2>Delivery</h2>
    ...
    <p>You must not use the service for unlawful activity, interfere with networks or devices, tamper with equipment, resell access without permission, or use the service in a way that breaches an overseas network operator’s terms.</p>
    <h2>Liability</h2>
