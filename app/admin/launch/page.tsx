...
import { hasRequiredEsimOrderSchema, hasRequiredFulfilmentEmailConfig, hasRequiredOperationsSchema, hasRequiredPaymentSchema, hasRequiredStripeWebhookConfig } from '@/lib/productionReadiness';
...
export default async function LaunchPage(){
 const [esimOrderDbOk, paymentDbOk, operationsDbOk]=await Promise.all([hasRequiredEsimOrderSchema(),hasRequiredPaymentSchema(),hasRequiredOperationsSchema()]);
 ...
 const wifiReady=commonCheckoutReady&&paymentDbOk&&wifiInventory;
 ...
 const wifiBlockers=[...commonBlockers,!paymentDbOk&&'Pocket WiFi payment and reservation schema',!wifiInventory&&'Pocket WiFi saleable-capacity setting'].filter(Boolean) as string[];
